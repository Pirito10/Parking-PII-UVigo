...
public class P7 {
    ...
    public static void main(String[] args) throws IOException, PIIFileArgumentNotFound {

        // Se comprueba si hay cinco argumentos de entrada (los nombres de los ficheros)
        if (args.length != 7) {
            System.out.println(
                    "Uso correcto: P7 <fichero_parking> <fichero_entradas_salidas> <fichero_parking_actualizado> <fichero_coches_ciudad> <fichero_lista_coches> <fichero_objetos_car> <fichero_potencias>");
        ...
        // ciudad
        cdb.readCityCarsFile("P7/" + args[3]);
        ...
        cdb.saveToBinary("P7/" + args[5]);

        cdb.savePowersToBinary("P7/" + args[6]);
    }
