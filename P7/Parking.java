...
public class Parking {
    ...
    public Parking(String filename) throws IOException {
        ...
        while (input.hasNext()) {
            ...
            if (carSpace != null) {
                ...
                carSpace.readPlateImage(partes[1] + ".jpg");
            }
    ...
    public void carEntry(Car car, String time) throws IOException {
        ...
        if (car instanceof CombustionCar) {
            ...
            carSpace.readPlateImage(car.getPlate() + ".jpg");
    ...
    public String carDeparture(String plate) throws IOException {
        ...
        for (CarSpace carSpace : busyCarSpaces) {
            ...
            if (carSpace.getPlate().equals(plate)) {
                ...
                carSpace.savePlateImage("plateImage_" + plate + ".jpg");
